...
*/
	...
	define('COPYSCAPE_USERNAME', $options['username']);
	define('COPYSCAPE_API_KEY',  $options['api_key']);
...
*/
	...
	if (@$run_examples) {
		...
		my_print_r(copyscape_api_text_add_to_private($exampletext, 'ISO-8859-1', 'Extract from Declaration of Independence', 'EXAMPLE_1234'));
